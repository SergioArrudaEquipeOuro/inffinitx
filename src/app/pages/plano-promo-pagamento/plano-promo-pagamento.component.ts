...
@Component({
  selector: 'app-plano-promo-pagamento',
  templateUrl: './plano-promo-pagamento.component.html',
  styleUrls: ['./plano-promo-pagamento.component.css']
})
export class PlanoPromoPagamentoComponent {
